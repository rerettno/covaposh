...
export default function CardProduct({ product }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="cursor-pointer group w-[48%] md:w-[30%] lg:w-[22%] xl:w-[18%] bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg hover:scale-[1.03] transition-transform duration-300 ease-in-out dark:bg-black-800 dark:border-gray-700"
    >
      {/* Image Section */}
      ...
      <div className="p-4 flex flex-col justify-between h-fit">
        ...
        <p className="text-darkBlue dark:text-gray-300 text-sm md:text-base font-bold mt-3">
          Rp.{" "}
